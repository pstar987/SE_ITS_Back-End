...
public class DevIssueBrowsePage extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("할당된 이슈 조회");
    ...
    private void initAssignIssueList(ProjectResponseDto currentProject, SwingIssueController swingIssueController,
                                     Long userId) {
        issueResponseDtos = swingIssueController.getDevIssues(userId, currentProject.getId());
