...
class ProjectServiceTest {
    ...
    @BeforeEach
    void setUp() {
        projectService = new ProjectService(projectRepository, projectMemberRepository, issueRepository, dtoConverter, entityValidator);
    }
    ...
    void testGetAllProject_AsAdmin_ShouldReturnAllProjects() {
        ...
        // Then
        assertThat(responseDtos).extracting("name");
    }
